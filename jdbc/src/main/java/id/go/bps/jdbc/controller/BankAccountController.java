package id.go.bps.jdbc.controller;
...
import id.go.bps.jdbc.service.BankAccountService;
import id.go.bps.jdbc.transaction.TransferFund;
...
public class BankAccountController {
	...
	public String listBankString(Model model) {
		List<BankAccount> listBankAccounts = bankAccountService.findAll();
